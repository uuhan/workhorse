...
1. Use `cargo work -- <cmd>` for short one-shot remote commands.
2. Use `cargo work exec` when the command is a multi-line script, contains JSON/headers/quotes/parens, or is generated by an agent and would otherwise need shell-layer escaping.
